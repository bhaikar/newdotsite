    ...
    <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg h-auto min-h-[260px] sm:min-h-[295px] md:min-h-[345px] lg:min-h-[385px] bg-gradient-to-br from-slate-800 via-slate-900 to-slate-950 transition-all duration-700 ease-in-out hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/20 group cursor-pointer overflow-hidden mx-auto rounded-lg"
      ...
      <div className="relative z-10 flex flex-col h-full p-3 sm:p-4 md:p-5 lg:p-6">
        <div className="relative mx-auto mt-2 sm:mt-3 md:mt-4 lg:mt-6 mb-3 sm:mb-4 group/image">
          <div className="w-24 h-24 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 rounded-xl sm:rounded-2xl overflow-hidden border-2 border-slate-600 group-hover:border-cyan-400 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-cyan-400/30">
            <Image
              src={imageSrc}
              alt={imageAlt}
        ...
        <span className="font-semibold text-white text-center block text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl mt-2 sm:mt-3 md:mt-4 transition-colors duration-300 group-hover:text-cyan-300 tracking-wide">
          {name}
        </span>
