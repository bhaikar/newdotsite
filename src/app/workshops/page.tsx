...
import Workshop from '@/components/ourworkcard';
...
const workshops = [
    {
        ...
        imageSrc: "/images/workshopimages/Python.png",
    ...
    },
    {
        ...
        imageSrc: "/images/workshopimages/webdev.jpg",
    ...
    },
    {
        ...
        imageSrc: "/images/workshopimages/Git.jpg",
        imageAlt: "git Hub"
    },
    {
        ...
        imageSrc: "/images/workshopimages/Canva.jpg",
        imageAlt: "Canva"
    },
    {
        ...
        imageSrc: "/images/workshopimages/Report.jpg",
    ...
    },
    {
        ...
        imageSrc: "/images/workshopimages/Digital.jpg",
        ...
        <div className="min-h-screen flex flex-col bg-gradient-to-b from-slate-900 via-slate-950 to-black">
            <Navbar />
             <div className="w-full min-h-screen flex flex-col items-center pt-20 pb-10"> 
                <h1 className="text-4xl font-bold text-white mb-1">Workshop</h1> 
                <div className="w-24 sm:w-32 lg:w-40 h-1 bg-gradient-to-r from-blue-500 to-purple-600 mx-auto mb-5 sm:mt-6 rounded-full"></div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8 px-8 justify-items-center">
